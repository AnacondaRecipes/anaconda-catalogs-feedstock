...
# About anaconda-catalogs
===========================

Feedstock license: [BSD-3-Clause](https://github.com/AnacondaRecipes/anaconda-catalogs/blob/main/LICENSE.txt)

Home: https://github.com/anaconda/anaconda-catalogs

Package license: BSD-3-Clause

Summary: Client library to interface with Nucleus catalogs service


Installing anaconda-catalogs
================

`anaconda-catalogs` can be installed with:
